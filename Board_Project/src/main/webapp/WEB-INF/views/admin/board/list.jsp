			...
			<div class="col-xl-12 col-lg-7">
    			<div class="card shadow mb-4">
					<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				        ...
				        <button class="btn btn-primary btn-icon-split" id="btn-write">
...
<%-- 							<input type="hidden" name="amount" value="${pageMaker.cri.amount }"  /> --%>
											...
											<table class="table table-bordered dataTable" id="dataTable" cellspacing="0" role="grid" aria-describedby="dataTable_info">
												...
												<thead>
												    <tr role="row">
														...
														<th class="sorting text-center" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending">작성일</th>
	...
	<!-- 																<a href="#" class="btn-danger btn-sm"><i class="fas fa-trash"></i></a> -->
													...
													<tr class="text-center">
														<td colspan="7"><strong class="text-lg"><br>등록된 게시물이 없습니다.<br><br></strong></td>
													</tr>
													</c:if>
									        	</tbody>
											</table>
									...
									<div class="row">
											...
											<div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate">
										 		<ul class="pagination">
									 			 	...
									 			 	<c:if test="${pageMaker.prev}">
														<li class="paginate_button page-item previous" id="dataTable_previous"><a href="/bbs/list.do?pageNum=${pageMaker.startPage-1}" aria-controls="dataTable" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li>
									 				</c:if>
									 				
									 				<!-- 페이지 번호 -->
													<c:forEach var="num" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
										 				<li class="paginate_button page-item <c:if test="${pageMaker.cri.pageNum eq num }"> active</c:if>"><a href="/bbs/list.do?pageNum=${num }&amp;searchKeyword=${bbsVO.searchKeyword}" aria-controls="dataTable" data-dt-idx="${num }" tabindex="0" class="page-link">${num }</a></li>
													</c:forEach>
													
													<!-- 다음페이지 버튼 -->
													<c:if test="${pageMaker.next}">
											  			<li class="pageInfo_btn page-item next" id="dataTable_next"><a href="/bbs/list.do?pageNum=${pageMaker.endPage + 1 }" aria-controls="dataTable" data-dt-idx="${pageMaker.endPage + 1 }" tabindex="0" class="page-link">Next</a></li>
													</c:if>
										 		</ul>
											</div>
										</div>
										<div class="col-sm-12 col-md-5 text-right">
											...
											<div class="input-group w-75" style="display: inline-flex; width: auto;">
									    		<input type="text" class="form-control bg-light border-0 small" name="searchKeyword" placeholder="게시물명을 입력하세요." aria-label="Search" aria-describedby="basic-addon2" autocomplete="off" value="${bbsVO.searchKeyword }">
			...
			<!-- <div class="col-xl-3 col-lg-5">
			    <div class="card shadow mb-4">
						...
						<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
						    <h6 class="m-0 font-weight-bold text-primary">게시물 <span id="ttl-typ">등록</span></h6>
						    <div class="dropdown no-arrow">
						    	<a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						    		<i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
								</a>
	                   		...
	                   		<form class="user" id="frm-addBbs">
	                    		...
	                    		<input type="hidden" name="bbsSeq" id="bbsSeq" value="0" readonly="readonly" />
	                      		<div class="form-group">
	                      			<label for="bbs-title"><strong>게시물명</strong></label>
	                          		<input type="email" class="form-control form-control-user init-class" name="nm" id="nm" placeholder="게시물명" autocomplete="off">
	                      		</div>
	                    		<div class="form-group">
	                      		...
	                      		<hr>
	                      		<small class="text-danger"><strong>*게시물 옵션을 선택하세요.</strong></small>
